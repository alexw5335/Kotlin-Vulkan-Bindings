...
class VulkanScraper(private val registry: ParsedRegistry) {
	...
	private fun enumNotEmpty(name: String) =
		(registry.typeElements.fromName(name) as EnumElement).entries.any { it.shouldGen }
	...
	private val VkType.resolveAlias: VkType
	...
	private val CommandElement.determineType: CommandType
		get() {
