...
value class BufferUsageFlags(val value: Int) {
	...
	companion object {
		...
		val VIDEO_DECODE_SRC = BufferUsageFlags(8192)
		
		val VIDEO_DECODE_DST = BufferUsageFlags(16384)
		...
		val VIDEO_ENCODE_DST = BufferUsageFlags(32768)
		
		val VIDEO_ENCODE_SRC = BufferUsageFlags(65536)
