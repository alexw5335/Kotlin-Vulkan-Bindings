...
inline fun Allocator.QueueFamilyQueryResultStatusProperties2(block: (QueueFamilyQueryResultStatusProperties2) -> Unit) = QueueFamilyQueryResultStatusProperties2(calloc(24)).apply(block).also { it.sType = 1000023016 }

inline fun Allocator.VideoQueueFamilyProperties2(block: (VideoQueueFamilyProperties2) -> Unit) = VideoQueueFamilyProperties2(calloc(24)).apply(block).also { it.sType = 1000023012 }

inline fun Allocator.VideoProfile(block: (VideoProfile) -> Unit) = VideoProfile(calloc(32)).apply(block).also { it.sType = 1000023000 }

inline fun Allocator.VideoProfiles(block: (VideoProfiles) -> Unit) = VideoProfiles(calloc(32)).apply(block).also { it.sType = 1000023013 }

inline fun Allocator.VideoCapabilities(block: (VideoCapabilities) -> Unit) = VideoCapabilities(calloc(72)).apply(block).also { it.sType = 1000023001 }

inline fun Allocator.PhysicalDeviceVideoFormatInfo(block: (PhysicalDeviceVideoFormatInfo) -> Unit) = PhysicalDeviceVideoFormatInfo(calloc(32)).apply(block).also { it.sType = 1000023014 }

inline fun Allocator.VideoFormatProperties(block: (VideoFormatProperties) -> Unit) = VideoFormatProperties(calloc(24)).apply(block).also { it.sType = 1000023015 }

inline fun Allocator.VideoFormatProperties(capacity: Int, block: (VideoFormatProperties.Buffer) -> Unit) = VideoFormatProperties.Buffer(calloc(capacity * 24), capacity).apply(block).apply { forEach { it.sType = 1000023015 } }

inline fun Allocator.VideoPictureResource(block: (VideoPictureResource) -> Unit) = VideoPictureResource(calloc(48)).apply(block).also { it.sType = 1000023002 }

inline fun Allocator.VideoReferenceSlot(block: (VideoReferenceSlot) -> Unit) = VideoReferenceSlot(calloc(32)).apply(block).also { it.sType = 1000023011 }

inline fun Allocator.VideoReferenceSlot(capacity: Int, block: (VideoReferenceSlot.Buffer) -> Unit) = VideoReferenceSlot.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000023011 } }

inline fun Allocator.VideoGetMemoryProperties(block: (VideoGetMemoryProperties) -> Unit) = VideoGetMemoryProperties(calloc(32)).apply(block).also { it.sType = 1000023003 }

inline fun Allocator.VideoGetMemoryProperties(capacity: Int, block: (VideoGetMemoryProperties.Buffer) -> Unit) = VideoGetMemoryProperties.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000023003 } }

inline fun Allocator.VideoBindMemory(block: (VideoBindMemory) -> Unit) = VideoBindMemory(calloc(48)).apply(block).also { it.sType = 1000023004 }

inline fun Allocator.VideoBindMemory(capacity: Int, block: (VideoBindMemory.Buffer) -> Unit) = VideoBindMemory.Buffer(calloc(capacity * 48), capacity).apply(block).apply { forEach { it.sType = 1000023004 } }

inline fun Allocator.VideoSessionCreateInfo(block: (VideoSessionCreateInfo) -> Unit) = VideoSessionCreateInfo(calloc(56)).apply(block).also { it.sType = 1000023005 }

inline fun Allocator.VideoSessionParametersCreateInfo(block: (VideoSessionParametersCreateInfo) -> Unit) = VideoSessionParametersCreateInfo(calloc(32)).apply(block).also { it.sType = 1000023006 }

inline fun Allocator.VideoSessionParametersUpdateInfo(block: (VideoSessionParametersUpdateInfo) -> Unit) = VideoSessionParametersUpdateInfo(calloc(24)).apply(block).also { it.sType = 1000023007 }

inline fun Allocator.VideoBeginCodingInfo(block: (VideoBeginCodingInfo) -> Unit) = VideoBeginCodingInfo(calloc(56)).apply(block).also { it.sType = 1000023008 }

inline fun Allocator.VideoEndCodingInfo(block: (VideoEndCodingInfo) -> Unit) = VideoEndCodingInfo(calloc(24)).apply(block).also { it.sType = 1000023009 }

inline fun Allocator.VideoCodingControlInfo(block: (VideoCodingControlInfo) -> Unit) = VideoCodingControlInfo(calloc(24)).apply(block).also { it.sType = 1000023010 }

inline fun Allocator.VideoDecodeInfo(block: (VideoDecodeInfo) -> Unit) = VideoDecodeInfo(calloc(136)).apply(block).also { it.sType = 1000024000 }
...
inline fun Allocator.CuModuleCreateInfo(block: (CuModuleCreateInfo) -> Unit) = CuModuleCreateInfo(calloc(32)).apply(block).also { it.sType = 1000029000 }

inline fun Allocator.CuFunctionCreateInfo(block: (CuFunctionCreateInfo) -> Unit) = CuFunctionCreateInfo(calloc(32)).apply(block).also { it.sType = 1000029001 }

inline fun Allocator.CuLaunchInfo(block: (CuLaunchInfo) -> Unit) = CuLaunchInfo(calloc(88)).apply(block).also { it.sType = 1000029002 }
...
inline fun Allocator.VideoEncodeH264Capabilities(block: (VideoEncodeH264Capabilities) -> Unit) = VideoEncodeH264Capabilities(calloc(320)).apply(block).also { it.sType = 1000038000 }

inline fun Allocator.VideoEncodeH264SessionCreateInfo(block: (VideoEncodeH264SessionCreateInfo) -> Unit) = VideoEncodeH264SessionCreateInfo(calloc(40)).apply(block).also { it.sType = 1000038001 }

inline fun Allocator.VideoEncodeH264SessionParametersCreateInfo(block: (VideoEncodeH264SessionParametersCreateInfo) -> Unit) = VideoEncodeH264SessionParametersCreateInfo(calloc(32)).apply(block).also { it.sType = 1000038002 }

inline fun Allocator.VideoEncodeH264SessionParametersAddInfo(block: (VideoEncodeH264SessionParametersAddInfo) -> Unit) = VideoEncodeH264SessionParametersAddInfo(calloc(48)).apply(block).also { it.sType = 1000038003 }

inline fun Allocator.VideoEncodeH264VclFrameInfo(block: (VideoEncodeH264VclFrameInfo) -> Unit) = VideoEncodeH264VclFrameInfo(calloc(72)).apply(block).also { it.sType = 1000038004 }

inline fun Allocator.VideoEncodeH264EmitPictureParameters(block: (VideoEncodeH264EmitPictureParameters) -> Unit) = VideoEncodeH264EmitPictureParameters(calloc(40)).apply(block).also { it.sType = 1000038007 }

inline fun Allocator.VideoEncodeH264DpbSlotInfo(block: (VideoEncodeH264DpbSlotInfo) -> Unit) = VideoEncodeH264DpbSlotInfo(calloc(32)).apply(block).also { it.sType = 1000038005 }

inline fun Allocator.VideoEncodeH264DpbSlotInfo(capacity: Int, block: (VideoEncodeH264DpbSlotInfo.Buffer) -> Unit) = VideoEncodeH264DpbSlotInfo.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000038005 } }

inline fun Allocator.VideoEncodeH264NaluSlice(block: (VideoEncodeH264NaluSlice) -> Unit) = VideoEncodeH264NaluSlice(calloc(56)).apply(block).also { it.sType = 1000038006 }

inline fun Allocator.VideoEncodeH264NaluSlice(capacity: Int, block: (VideoEncodeH264NaluSlice.Buffer) -> Unit) = VideoEncodeH264NaluSlice.Buffer(calloc(capacity * 56), capacity).apply(block).apply { forEach { it.sType = 1000038006 } }

inline fun Allocator.VideoEncodeH264Profile(block: (VideoEncodeH264Profile) -> Unit) = VideoEncodeH264Profile(calloc(24)).apply(block).also { it.sType = 1000038008 }

inline fun Allocator.VideoEncodeH264RateControlInfo(block: (VideoEncodeH264RateControlInfo) -> Unit) = VideoEncodeH264RateControlInfo(calloc(40)).apply(block).also { it.sType = 1000038009 }

inline fun Allocator.VideoEncodeH264RateControlLayerInfo(block: (VideoEncodeH264RateControlLayerInfo) -> Unit) = VideoEncodeH264RateControlLayerInfo(calloc(88)).apply(block).also { it.sType = 1000038010 }

inline fun Allocator.VideoEncodeH264Qp(block: (VideoEncodeH264Qp) -> Unit) = VideoEncodeH264Qp(calloc(12)).apply(block)

inline fun Allocator.VideoEncodeH264FrameSize(block: (VideoEncodeH264FrameSize) -> Unit) = VideoEncodeH264FrameSize(calloc(12)).apply(block)

inline fun Allocator.VideoEncodeH265Capabilities(block: (VideoEncodeH265Capabilities) -> Unit) = VideoEncodeH265Capabilities(calloc(312)).apply(block).also { it.sType = 1000039000 }

inline fun Allocator.VideoEncodeH265SessionCreateInfo(block: (VideoEncodeH265SessionCreateInfo) -> Unit) = VideoEncodeH265SessionCreateInfo(calloc(32)).apply(block).also { it.sType = 1000039001 }

inline fun Allocator.VideoEncodeH265SessionParametersCreateInfo(block: (VideoEncodeH265SessionParametersCreateInfo) -> Unit) = VideoEncodeH265SessionParametersCreateInfo(calloc(40)).apply(block).also { it.sType = 1000039002 }

inline fun Allocator.VideoEncodeH265SessionParametersAddInfo(block: (VideoEncodeH265SessionParametersAddInfo) -> Unit) = VideoEncodeH265SessionParametersAddInfo(calloc(64)).apply(block).also { it.sType = 1000039003 }

inline fun Allocator.VideoEncodeH265VclFrameInfo(block: (VideoEncodeH265VclFrameInfo) -> Unit) = VideoEncodeH265VclFrameInfo(calloc(48)).apply(block).also { it.sType = 1000039004 }

inline fun Allocator.VideoEncodeH265EmitPictureParameters(block: (VideoEncodeH265EmitPictureParameters) -> Unit) = VideoEncodeH265EmitPictureParameters(calloc(40)).apply(block).also { it.sType = 1000039007 }

inline fun Allocator.VideoEncodeH265DpbSlotInfo(block: (VideoEncodeH265DpbSlotInfo) -> Unit) = VideoEncodeH265DpbSlotInfo(calloc(32)).apply(block).also { it.sType = 1000039005 }

inline fun Allocator.VideoEncodeH265DpbSlotInfo(capacity: Int, block: (VideoEncodeH265DpbSlotInfo.Buffer) -> Unit) = VideoEncodeH265DpbSlotInfo.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000039005 } }

inline fun Allocator.VideoEncodeH265NaluSlice(block: (VideoEncodeH265NaluSlice) -> Unit) = VideoEncodeH265NaluSlice(calloc(40)).apply(block).also { it.sType = 1000039006 }

inline fun Allocator.VideoEncodeH265NaluSlice(capacity: Int, block: (VideoEncodeH265NaluSlice.Buffer) -> Unit) = VideoEncodeH265NaluSlice.Buffer(calloc(capacity * 40), capacity).apply(block).apply { forEach { it.sType = 1000039006 } }

inline fun Allocator.VideoEncodeH265Profile(block: (VideoEncodeH265Profile) -> Unit) = VideoEncodeH265Profile(calloc(24)).apply(block).also { it.sType = 1000039008 }

inline fun Allocator.VideoEncodeH265ReferenceLists(block: (VideoEncodeH265ReferenceLists) -> Unit) = VideoEncodeH265ReferenceLists(calloc(56)).apply(block).also { it.sType = 1000039009 }

inline fun Allocator.VideoEncodeH265RateControlInfo(block: (VideoEncodeH265RateControlInfo) -> Unit) = VideoEncodeH265RateControlInfo(calloc(40)).apply(block).also { it.sType = 1000039010 }

inline fun Allocator.VideoEncodeH265RateControlLayerInfo(block: (VideoEncodeH265RateControlLayerInfo) -> Unit) = VideoEncodeH265RateControlLayerInfo(calloc(88)).apply(block).also { it.sType = 1000039011 }

inline fun Allocator.VideoEncodeH265Qp(block: (VideoEncodeH265Qp) -> Unit) = VideoEncodeH265Qp(calloc(12)).apply(block)

inline fun Allocator.VideoEncodeH265FrameSize(block: (VideoEncodeH265FrameSize) -> Unit) = VideoEncodeH265FrameSize(calloc(12)).apply(block)

inline fun Allocator.VideoDecodeH264Profile(block: (VideoDecodeH264Profile) -> Unit) = VideoDecodeH264Profile(calloc(32)).apply(block).also { it.sType = 1000040004 }

inline fun Allocator.VideoDecodeH264Capabilities(block: (VideoDecodeH264Capabilities) -> Unit) = VideoDecodeH264Capabilities(calloc(288)).apply(block).also { it.sType = 1000040000 }

inline fun Allocator.VideoDecodeH264SessionCreateInfo(block: (VideoDecodeH264SessionCreateInfo) -> Unit) = VideoDecodeH264SessionCreateInfo(calloc(32)).apply(block).also { it.sType = 1000040001 }

inline fun Allocator.VideoDecodeH264SessionParametersCreateInfo(block: (VideoDecodeH264SessionParametersCreateInfo) -> Unit) = VideoDecodeH264SessionParametersCreateInfo(calloc(32)).apply(block).also { it.sType = 1000040005 }

inline fun Allocator.VideoDecodeH264SessionParametersAddInfo(block: (VideoDecodeH264SessionParametersAddInfo) -> Unit) = VideoDecodeH264SessionParametersAddInfo(calloc(48)).apply(block).also { it.sType = 1000040006 }

inline fun Allocator.VideoDecodeH264PictureInfo(block: (VideoDecodeH264PictureInfo) -> Unit) = VideoDecodeH264PictureInfo(calloc(40)).apply(block).also { it.sType = 1000040002 }

inline fun Allocator.VideoDecodeH264Mvc(block: (VideoDecodeH264Mvc) -> Unit) = VideoDecodeH264Mvc(calloc(24)).apply(block).also { it.sType = 1000040003 }

inline fun Allocator.VideoDecodeH264DpbSlotInfo(block: (VideoDecodeH264DpbSlotInfo) -> Unit) = VideoDecodeH264DpbSlotInfo(calloc(24)).apply(block).also { it.sType = 1000040007 }
...
inline fun Allocator.RenderingFragmentShadingRateAttachmentInfo(block: (RenderingFragmentShadingRateAttachmentInfo) -> Unit) = RenderingFragmentShadingRateAttachmentInfo(calloc(40)).apply(block).also { it.sType = 1000044006 }

inline fun Allocator.RenderingFragmentDensityMapAttachmentInfo(block: (RenderingFragmentDensityMapAttachmentInfo) -> Unit) = RenderingFragmentDensityMapAttachmentInfo(calloc(32)).apply(block).also { it.sType = 1000044007 }

inline fun Allocator.AttachmentSampleCountInfo(block: (AttachmentSampleCountInfo) -> Unit) = AttachmentSampleCountInfo(calloc(40)).apply(block).also { it.sType = 1000044008 }

inline fun Allocator.MultiviewPerViewAttributesInfo(block: (MultiviewPerViewAttributesInfo) -> Unit) = MultiviewPerViewAttributesInfo(calloc(24)).apply(block).also { it.sType = 1000044009 }
...
inline fun Allocator.VkSurfaceCapabilities2EXT(block: (VkSurfaceCapabilities2EXT) -> Unit) = VkSurfaceCapabilities2EXT(calloc(72)).apply(block).also { it.sType = 1000090000 }
...
inline fun Allocator.VkSurfaceCapabilities2KHR(block: (VkSurfaceCapabilities2KHR) -> Unit) = VkSurfaceCapabilities2KHR(calloc(72)).apply(block).also { it.sType = 1000119001 }
...
inline fun Allocator.AndroidHardwareBufferFormatProperties2(block: (AndroidHardwareBufferFormatProperties2) -> Unit) = AndroidHardwareBufferFormatProperties2(calloc(72)).apply(block).also { it.sType = 1000129006 }
...
inline fun Allocator.VkAccelerationStructureCreateInfoKHR(block: (VkAccelerationStructureCreateInfoKHR) -> Unit) = VkAccelerationStructureCreateInfoKHR(calloc(64)).apply(block).also { it.sType = 1000150017 }

inline fun Allocator.VkWriteDescriptorSetAccelerationStructureKHR(block: (VkWriteDescriptorSetAccelerationStructureKHR) -> Unit) = VkWriteDescriptorSetAccelerationStructureKHR(calloc(32)).apply(block).also { it.sType = 1000150007 }
...
inline fun Allocator.VkRayTracingShaderGroupCreateInfoKHR(block: (VkRayTracingShaderGroupCreateInfoKHR) -> Unit) = VkRayTracingShaderGroupCreateInfoKHR(calloc(48)).apply(block).also { it.sType = 1000150016 }

inline fun Allocator.VkRayTracingShaderGroupCreateInfoKHR(capacity: Int, block: (VkRayTracingShaderGroupCreateInfoKHR.Buffer) -> Unit) = VkRayTracingShaderGroupCreateInfoKHR.Buffer(calloc(capacity * 48), capacity).apply(block).apply { forEach { it.sType = 1000150016 } }

inline fun Allocator.VkRayTracingPipelineCreateInfoKHR(block: (VkRayTracingPipelineCreateInfoKHR) -> Unit) = VkRayTracingPipelineCreateInfoKHR(calloc(104)).apply(block).also { it.sType = 1000150015 }

inline fun Allocator.VkRayTracingPipelineCreateInfoKHR(capacity: Int, block: (VkRayTracingPipelineCreateInfoKHR.Buffer) -> Unit) = VkRayTracingPipelineCreateInfoKHR.Buffer(calloc(capacity * 104), capacity).apply(block).apply { forEach { it.sType = 1000150015 } }
...
inline fun Allocator.DrmFormatModifierPropertiesList2(block: (DrmFormatModifierPropertiesList2) -> Unit) = DrmFormatModifierPropertiesList2(calloc(32)).apply(block).also { it.sType = 1000158006 }

inline fun Allocator.DrmFormatModifierProperties2(block: (DrmFormatModifierProperties2) -> Unit) = DrmFormatModifierProperties2(calloc(24)).apply(block)

inline fun Allocator.DrmFormatModifierProperties2(capacity: Int, block: (DrmFormatModifierProperties2.Buffer) -> Unit) = DrmFormatModifierProperties2.Buffer(calloc(capacity * 24), capacity).apply(block)
...
inline fun Allocator.VkRayTracingShaderGroupCreateInfoNV(block: (VkRayTracingShaderGroupCreateInfoNV) -> Unit) = VkRayTracingShaderGroupCreateInfoNV(calloc(40)).apply(block).also { it.sType = 1000165011 }

inline fun Allocator.VkRayTracingShaderGroupCreateInfoNV(capacity: Int, block: (VkRayTracingShaderGroupCreateInfoNV.Buffer) -> Unit) = VkRayTracingShaderGroupCreateInfoNV.Buffer(calloc(capacity * 40), capacity).apply(block).apply { forEach { it.sType = 1000165011 } }

inline fun Allocator.VkRayTracingPipelineCreateInfoNV(block: (VkRayTracingPipelineCreateInfoNV) -> Unit) = VkRayTracingPipelineCreateInfoNV(calloc(80)).apply(block).also { it.sType = 1000165000 }

inline fun Allocator.VkRayTracingPipelineCreateInfoNV(capacity: Int, block: (VkRayTracingPipelineCreateInfoNV.Buffer) -> Unit) = VkRayTracingPipelineCreateInfoNV.Buffer(calloc(capacity * 80), capacity).apply(block).apply { forEach { it.sType = 1000165000 } }
...
inline fun Allocator.VkAccelerationStructureCreateInfoNV(block: (VkAccelerationStructureCreateInfoNV) -> Unit) = VkAccelerationStructureCreateInfoNV(calloc(64)).apply(block).also { it.sType = 1000165001 }
...
inline fun Allocator.VkWriteDescriptorSetAccelerationStructureNV(block: (VkWriteDescriptorSetAccelerationStructureNV) -> Unit) = VkWriteDescriptorSetAccelerationStructureNV(calloc(32)).apply(block).also { it.sType = 1000165007 }
...
inline fun Allocator.VideoDecodeH265Profile(block: (VideoDecodeH265Profile) -> Unit) = VideoDecodeH265Profile(calloc(24)).apply(block).also { it.sType = 1000187004 }

inline fun Allocator.VideoDecodeH265Capabilities(block: (VideoDecodeH265Capabilities) -> Unit) = VideoDecodeH265Capabilities(calloc(280)).apply(block).also { it.sType = 1000187000 }

inline fun Allocator.VideoDecodeH265SessionCreateInfo(block: (VideoDecodeH265SessionCreateInfo) -> Unit) = VideoDecodeH265SessionCreateInfo(calloc(32)).apply(block).also { it.sType = 1000187001 }

inline fun Allocator.VideoDecodeH265SessionParametersCreateInfo(block: (VideoDecodeH265SessionParametersCreateInfo) -> Unit) = VideoDecodeH265SessionParametersCreateInfo(calloc(32)).apply(block).also { it.sType = 1000187002 }

inline fun Allocator.VideoDecodeH265SessionParametersAddInfo(block: (VideoDecodeH265SessionParametersAddInfo) -> Unit) = VideoDecodeH265SessionParametersAddInfo(calloc(48)).apply(block).also { it.sType = 1000187003 }

inline fun Allocator.VideoDecodeH265PictureInfo(block: (VideoDecodeH265PictureInfo) -> Unit) = VideoDecodeH265PictureInfo(calloc(40)).apply(block).also { it.sType = 1000187005 }

inline fun Allocator.VideoDecodeH265DpbSlotInfo(block: (VideoDecodeH265DpbSlotInfo) -> Unit) = VideoDecodeH265DpbSlotInfo(calloc(24)).apply(block).also { it.sType = 1000187006 }
...
inline fun Allocator.PhysicalDevicePresentWaitFeatures(block: (PhysicalDevicePresentWaitFeatures) -> Unit) = PhysicalDevicePresentWaitFeatures(calloc(24)).apply(block).also { it.sType = 1000248000 }
...
inline fun Allocator.PhysicalDeviceProvokingVertexFeatures(block: (PhysicalDeviceProvokingVertexFeatures) -> Unit) = PhysicalDeviceProvokingVertexFeatures(calloc(24)).apply(block).also { it.sType = 1000254000 }

inline fun Allocator.PhysicalDeviceProvokingVertexProperties(block: (PhysicalDeviceProvokingVertexProperties) -> Unit) = PhysicalDeviceProvokingVertexProperties(calloc(24)).apply(block).also { it.sType = 1000254002 }

inline fun Allocator.PipelineRasterizationProvokingVertexStateCreateInfo(block: (PipelineRasterizationProvokingVertexStateCreateInfo) -> Unit) = PipelineRasterizationProvokingVertexStateCreateInfo(calloc(24)).apply(block).also { it.sType = 1000254001 }
...
inline fun Allocator.PhysicalDeviceShaderAtomicFloat2Features(block: (PhysicalDeviceShaderAtomicFloat2Features) -> Unit) = PhysicalDeviceShaderAtomicFloat2Features(calloc(64)).apply(block).also { it.sType = 1000273000 }
...
inline fun Allocator.PhysicalDeviceInheritedViewportScissorFeatures(block: (PhysicalDeviceInheritedViewportScissorFeatures) -> Unit) = PhysicalDeviceInheritedViewportScissorFeatures(calloc(24)).apply(block).also { it.sType = 1000278000 }

inline fun Allocator.CommandBufferInheritanceViewportScissorInfo(block: (CommandBufferInheritanceViewportScissorInfo) -> Unit) = CommandBufferInheritanceViewportScissorInfo(calloc(32)).apply(block).also { it.sType = 1000278001 }
...
inline fun Allocator.PresentId(block: (PresentId) -> Unit) = PresentId(calloc(32)).apply(block).also { it.sType = 1000294000 }

inline fun Allocator.PhysicalDevicePresentIdFeatures(block: (PhysicalDevicePresentIdFeatures) -> Unit) = PhysicalDevicePresentIdFeatures(calloc(24)).apply(block).also { it.sType = 1000294001 }
...
inline fun Allocator.VideoEncodeInfo(block: (VideoEncodeInfo) -> Unit) = VideoEncodeInfo(calloc(136)).apply(block).also { it.sType = 1000299000 }

inline fun Allocator.VideoEncodeRateControlInfo(block: (VideoEncodeRateControlInfo) -> Unit) = VideoEncodeRateControlInfo(calloc(40)).apply(block).also { it.sType = 1000299001 }

inline fun Allocator.VideoEncodeRateControlLayerInfo(block: (VideoEncodeRateControlLayerInfo) -> Unit) = VideoEncodeRateControlLayerInfo(calloc(40)).apply(block).also { it.sType = 1000299002 }

inline fun Allocator.VideoEncodeRateControlLayerInfo(capacity: Int, block: (VideoEncodeRateControlLayerInfo.Buffer) -> Unit) = VideoEncodeRateControlLayerInfo.Buffer(calloc(capacity * 40), capacity).apply(block).apply { forEach { it.sType = 1000299002 } }
...
inline fun Allocator.PhysicalDeviceShaderSubgroupUniformControlFlowFeatures(block: (PhysicalDeviceShaderSubgroupUniformControlFlowFeatures) -> Unit) = PhysicalDeviceShaderSubgroupUniformControlFlowFeatures(calloc(24)).apply(block).also { it.sType = 1000323000 }
...
inline fun Allocator.AccelerationStructureGeometryMotionTrianglesData(block: (AccelerationStructureGeometryMotionTrianglesData) -> Unit) = AccelerationStructureGeometryMotionTrianglesData(calloc(24)).apply(block).also { it.sType = 1000327000 }

inline fun Allocator.AccelerationStructureMotionInfo(block: (AccelerationStructureMotionInfo) -> Unit) = AccelerationStructureMotionInfo(calloc(24)).apply(block).also { it.sType = 1000327002 }

inline fun Allocator.AccelerationStructureMotionInstance(block: (AccelerationStructureMotionInstance) -> Unit) = AccelerationStructureMotionInstance(calloc(160)).apply(block)

inline fun Allocator.AccelerationStructureMotionInstanceData(block: (AccelerationStructureMotionInstanceData) -> Unit) = AccelerationStructureMotionInstanceData(calloc(152)).apply(block)

inline fun Allocator.AccelerationStructureMatrixMotionInstance(block: (AccelerationStructureMatrixMotionInstance) -> Unit) = AccelerationStructureMatrixMotionInstance(calloc(56)).apply(block)

inline fun Allocator.AccelerationStructureSRTMotionInstance(block: (AccelerationStructureSRTMotionInstance) -> Unit) = AccelerationStructureSRTMotionInstance(calloc(152)).apply(block)

inline fun Allocator.SRTData(block: (SRTData) -> Unit) = SRTData(calloc(64)).apply(block)

inline fun Allocator.PhysicalDeviceRayTracingMotionBlurFeatures(block: (PhysicalDeviceRayTracingMotionBlurFeatures) -> Unit) = PhysicalDeviceRayTracingMotionBlurFeatures(calloc(24)).apply(block).also { it.sType = 1000327001 }

inline fun Allocator.PhysicalDeviceYcbcr2Plane444FormatsFeatures(block: (PhysicalDeviceYcbcr2Plane444FormatsFeatures) -> Unit) = PhysicalDeviceYcbcr2Plane444FormatsFeatures(calloc(24)).apply(block).also { it.sType = 1000330000 }
...
inline fun Allocator.PhysicalDeviceRasterizationOrderAttachmentAccessFeatures(block: (PhysicalDeviceRasterizationOrderAttachmentAccessFeatures) -> Unit) = PhysicalDeviceRasterizationOrderAttachmentAccessFeatures(calloc(32)).apply(block).also { it.sType = 1000342000 }

inline fun Allocator.PhysicalDeviceRGBA10X6FormatsFeatures(block: (PhysicalDeviceRGBA10X6FormatsFeatures) -> Unit) = PhysicalDeviceRGBA10X6FormatsFeatures(calloc(24)).apply(block).also { it.sType = 1000344000 }
...
inline fun Allocator.PhysicalDeviceVertexInputDynamicStateFeatures(block: (PhysicalDeviceVertexInputDynamicStateFeatures) -> Unit) = PhysicalDeviceVertexInputDynamicStateFeatures(calloc(24)).apply(block).also { it.sType = 1000352000 }

inline fun Allocator.VertexInputBindingDescription2(block: (VertexInputBindingDescription2) -> Unit) = VertexInputBindingDescription2(calloc(32)).apply(block).also { it.sType = 1000352001 }

inline fun Allocator.VertexInputBindingDescription2(capacity: Int, block: (VertexInputBindingDescription2.Buffer) -> Unit) = VertexInputBindingDescription2.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000352001 } }

inline fun Allocator.VertexInputAttributeDescription2(block: (VertexInputAttributeDescription2) -> Unit) = VertexInputAttributeDescription2(calloc(32)).apply(block).also { it.sType = 1000352002 }

inline fun Allocator.VertexInputAttributeDescription2(capacity: Int, block: (VertexInputAttributeDescription2.Buffer) -> Unit) = VertexInputAttributeDescription2.Buffer(calloc(capacity * 32), capacity).apply(block).apply { forEach { it.sType = 1000352002 } }

inline fun Allocator.PhysicalDeviceDrmProperties(block: (PhysicalDeviceDrmProperties) -> Unit) = PhysicalDeviceDrmProperties(calloc(56)).apply(block).also { it.sType = 1000353000 }

inline fun Allocator.PhysicalDeviceDepthClipControlFeatures(block: (PhysicalDeviceDepthClipControlFeatures) -> Unit) = PhysicalDeviceDepthClipControlFeatures(calloc(24)).apply(block).also { it.sType = 1000355000 }

inline fun Allocator.PipelineViewportDepthClipControlCreateInfo(block: (PipelineViewportDepthClipControlCreateInfo) -> Unit) = PipelineViewportDepthClipControlCreateInfo(calloc(24)).apply(block).also { it.sType = 1000355001 }

inline fun Allocator.PhysicalDevicePrimitiveTopologyListRestartFeatures(block: (PhysicalDevicePrimitiveTopologyListRestartFeatures) -> Unit) = PhysicalDevicePrimitiveTopologyListRestartFeatures(calloc(24)).apply(block).also { it.sType = 1000356000 }
...
inline fun Allocator.BufferCollectionCreateInfo(block: (BufferCollectionCreateInfo) -> Unit) = BufferCollectionCreateInfo(calloc(24)).apply(block).also { it.sType = 1000366000 }

inline fun Allocator.ImportMemoryBufferCollection(block: (ImportMemoryBufferCollection) -> Unit) = ImportMemoryBufferCollection(calloc(32)).apply(block).also { it.sType = 1000366001 }

inline fun Allocator.BufferCollectionImageCreateInfo(block: (BufferCollectionImageCreateInfo) -> Unit) = BufferCollectionImageCreateInfo(calloc(32)).apply(block).also { it.sType = 1000366002 }

inline fun Allocator.BufferConstraintsInfo(block: (BufferConstraintsInfo) -> Unit) = BufferConstraintsInfo(calloc(120)).apply(block).also { it.sType = 1000366004 }

inline fun Allocator.BufferCollectionBufferCreateInfo(block: (BufferCollectionBufferCreateInfo) -> Unit) = BufferCollectionBufferCreateInfo(calloc(32)).apply(block).also { it.sType = 1000366005 }

inline fun Allocator.BufferCollectionProperties(block: (BufferCollectionProperties) -> Unit) = BufferCollectionProperties(calloc(104)).apply(block).also { it.sType = 1000366003 }

inline fun Allocator.SysmemColorSpace(block: (SysmemColorSpace) -> Unit) = SysmemColorSpace(calloc(24)).apply(block).also { it.sType = 1000366008 }

inline fun Allocator.ImageConstraintsInfo(block: (ImageConstraintsInfo) -> Unit) = ImageConstraintsInfo(calloc(80)).apply(block).also { it.sType = 1000366006 }

inline fun Allocator.ImageFormatConstraintsInfo(block: (ImageFormatConstraintsInfo) -> Unit) = ImageFormatConstraintsInfo(calloc(136)).apply(block).also { it.sType = 1000366007 }

inline fun Allocator.ImageFormatConstraintsInfo(capacity: Int, block: (ImageFormatConstraintsInfo.Buffer) -> Unit) = ImageFormatConstraintsInfo.Buffer(calloc(capacity * 136), capacity).apply(block).apply { forEach { it.sType = 1000366007 } }

inline fun Allocator.BufferCollectionConstraintsInfo(block: (BufferCollectionConstraintsInfo) -> Unit) = BufferCollectionConstraintsInfo(calloc(40)).apply(block).also { it.sType = 1000366009 }

inline fun Allocator.SubpassShadingPipelineCreateInfo(block: (SubpassShadingPipelineCreateInfo) -> Unit) = SubpassShadingPipelineCreateInfo(calloc(32)).apply(block).also { it.sType = 1000369000 }

inline fun Allocator.PhysicalDeviceSubpassShadingFeatures(block: (PhysicalDeviceSubpassShadingFeatures) -> Unit) = PhysicalDeviceSubpassShadingFeatures(calloc(24)).apply(block).also { it.sType = 1000369001 }

inline fun Allocator.PhysicalDeviceSubpassShadingProperties(block: (PhysicalDeviceSubpassShadingProperties) -> Unit) = PhysicalDeviceSubpassShadingProperties(calloc(24)).apply(block).also { it.sType = 1000369002 }

inline fun Allocator.PhysicalDeviceInvocationMaskFeatures(block: (PhysicalDeviceInvocationMaskFeatures) -> Unit) = PhysicalDeviceInvocationMaskFeatures(calloc(24)).apply(block).also { it.sType = 1000370000 }

inline fun Allocator.MemoryGetRemoteAddressInfo(block: (MemoryGetRemoteAddressInfo) -> Unit) = MemoryGetRemoteAddressInfo(calloc(32)).apply(block).also { it.sType = 1000371000 }

inline fun Allocator.PhysicalDeviceExternalMemoryRDMAFeatures(block: (PhysicalDeviceExternalMemoryRDMAFeatures) -> Unit) = PhysicalDeviceExternalMemoryRDMAFeatures(calloc(24)).apply(block).also { it.sType = 1000371001 }

inline fun Allocator.PhysicalDeviceExtendedDynamicState2Features(block: (PhysicalDeviceExtendedDynamicState2Features) -> Unit) = PhysicalDeviceExtendedDynamicState2Features(calloc(32)).apply(block).also { it.sType = 1000377000 }
...
inline fun Allocator.PhysicalDeviceColorWriteEnableFeatures(block: (PhysicalDeviceColorWriteEnableFeatures) -> Unit) = PhysicalDeviceColorWriteEnableFeatures(calloc(24)).apply(block).also { it.sType = 1000381000 }

inline fun Allocator.PipelineColorWriteCreateInfo(block: (PipelineColorWriteCreateInfo) -> Unit) = PipelineColorWriteCreateInfo(calloc(32)).apply(block).also { it.sType = 1000381001 }

inline fun Allocator.PhysicalDeviceGlobalPriorityQueryFeatures(block: (PhysicalDeviceGlobalPriorityQueryFeatures) -> Unit) = PhysicalDeviceGlobalPriorityQueryFeatures(calloc(24)).apply(block).also { it.sType = 1000388000 }

inline fun Allocator.QueueFamilyGlobalPriorityProperties(block: (QueueFamilyGlobalPriorityProperties) -> Unit) = QueueFamilyGlobalPriorityProperties(calloc(88)).apply(block).also { it.sType = 1000388001 }

inline fun Allocator.PhysicalDeviceImageViewMinLodFeatures(block: (PhysicalDeviceImageViewMinLodFeatures) -> Unit) = PhysicalDeviceImageViewMinLodFeatures(calloc(24)).apply(block).also { it.sType = 1000391000 }

inline fun Allocator.ImageViewMinLodCreateInfo(block: (ImageViewMinLodCreateInfo) -> Unit) = ImageViewMinLodCreateInfo(calloc(24)).apply(block).also { it.sType = 1000391001 }

inline fun Allocator.PhysicalDeviceMultiDrawFeatures(block: (PhysicalDeviceMultiDrawFeatures) -> Unit) = PhysicalDeviceMultiDrawFeatures(calloc(24)).apply(block).also { it.sType = 1000392000 }

inline fun Allocator.PhysicalDeviceMultiDrawProperties(block: (PhysicalDeviceMultiDrawProperties) -> Unit) = PhysicalDeviceMultiDrawProperties(calloc(24)).apply(block).also { it.sType = 1000392001 }

inline fun Allocator.MultiDrawInfo(block: (MultiDrawInfo) -> Unit) = MultiDrawInfo(calloc(8)).apply(block)

inline fun Allocator.MultiDrawInfo(capacity: Int, block: (MultiDrawInfo.Buffer) -> Unit) = MultiDrawInfo.Buffer(calloc(capacity * 8), capacity).apply(block)

inline fun Allocator.MultiDrawIndexedInfo(block: (MultiDrawIndexedInfo) -> Unit) = MultiDrawIndexedInfo(calloc(12)).apply(block)

inline fun Allocator.MultiDrawIndexedInfo(capacity: Int, block: (MultiDrawIndexedInfo.Buffer) -> Unit) = MultiDrawIndexedInfo.Buffer(calloc(capacity * 12), capacity).apply(block)

inline fun Allocator.PhysicalDeviceBorderColorSwizzleFeatures(block: (PhysicalDeviceBorderColorSwizzleFeatures) -> Unit) = PhysicalDeviceBorderColorSwizzleFeatures(calloc(24)).apply(block).also { it.sType = 1000411000 }

inline fun Allocator.SamplerBorderColorComponentMappingCreateInfo(block: (SamplerBorderColorComponentMappingCreateInfo) -> Unit) = SamplerBorderColorComponentMappingCreateInfo(calloc(40)).apply(block).also { it.sType = 1000411001 }

inline fun Allocator.PhysicalDevicePageableDeviceLocalMemoryFeatures(block: (PhysicalDevicePageableDeviceLocalMemoryFeatures) -> Unit) = PhysicalDevicePageableDeviceLocalMemoryFeatures(calloc(24)).apply(block).also { it.sType = 1000412000 }
...
inline fun Allocator.PhysicalDeviceFragmentDensityMapOffsetFeatures(block: (PhysicalDeviceFragmentDensityMapOffsetFeatures) -> Unit) = PhysicalDeviceFragmentDensityMapOffsetFeatures(calloc(24)).apply(block).also { it.sType = 1000425000 }

inline fun Allocator.PhysicalDeviceFragmentDensityMapOffsetProperties(block: (PhysicalDeviceFragmentDensityMapOffsetProperties) -> Unit) = PhysicalDeviceFragmentDensityMapOffsetProperties(calloc(24)).apply(block).also { it.sType = 1000425001 }

inline fun Allocator.SubpassFragmentDensityMapOffsetEndInfo(block: (SubpassFragmentDensityMapOffsetEndInfo) -> Unit) = SubpassFragmentDensityMapOffsetEndInfo(calloc(32)).apply(block).also { it.sType = 1000425002 }

inline fun Allocator.PhysicalDeviceLinearColorAttachmentFeatures(block: (PhysicalDeviceLinearColorAttachmentFeatures) -> Unit) = PhysicalDeviceLinearColorAttachmentFeatures(calloc(24)).apply(block).also { it.sType = 1000430000 }