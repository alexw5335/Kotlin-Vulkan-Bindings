...
value class Format(val value: Int) {
	...
	companion object {
		...
		val PVRTC1_2BPP_UNORM_BLOCK = Format(1000054000)
		
		val PVRTC1_4BPP_UNORM_BLOCK = Format(1000054001)
		
		val PVRTC2_2BPP_UNORM_BLOCK = Format(1000054002)
		
		val PVRTC2_4BPP_UNORM_BLOCK = Format(1000054003)
		
		val PVRTC1_2BPP_SRGB_BLOCK = Format(1000054004)
		
		val PVRTC1_4BPP_SRGB_BLOCK = Format(1000054005)
		
		val PVRTC2_2BPP_SRGB_BLOCK = Format(1000054006)
		
		val PVRTC2_4BPP_SRGB_BLOCK = Format(1000054007)
	...
	override fun toString() = when(value) {
		...
		1000054000 -> "PVRTC1_2BPP_UNORM_BLOCK"
		1000054001 -> "PVRTC1_4BPP_UNORM_BLOCK"
		1000054002 -> "PVRTC2_2BPP_UNORM_BLOCK"
		1000054003 -> "PVRTC2_4BPP_UNORM_BLOCK"
		1000054004 -> "PVRTC1_2BPP_SRGB_BLOCK"
		1000054005 -> "PVRTC1_4BPP_SRGB_BLOCK"
		1000054006 -> "PVRTC2_2BPP_SRGB_BLOCK"
		1000054007 -> "PVRTC2_4BPP_SRGB_BLOCK"
