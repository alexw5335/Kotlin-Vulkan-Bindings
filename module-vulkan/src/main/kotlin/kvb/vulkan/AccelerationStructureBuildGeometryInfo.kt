...
value class AccelerationStructureBuildGeometryInfo(override val address: Long) : Addressable {
	...
	var srcAccelerationStructure: VkAccelerationStructureKHRH
		get()      = VkAccelerationStructureKHRH(Unsafe.getLong(address + 32))
		set(value) = Unsafe.setLong(address + 32, value.address)
	
	var dstAccelerationStructure: VkAccelerationStructureKHRH
		get()      = VkAccelerationStructureKHRH(Unsafe.getLong(address + 40))
