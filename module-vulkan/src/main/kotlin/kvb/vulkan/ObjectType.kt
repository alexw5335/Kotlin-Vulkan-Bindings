...
value class ObjectType(val value: Int) {
	...
	companion object {
		...
		val VIDEO_SESSION = ObjectType(1000023000)
		
		val VIDEO_SESSION_PARAMETERS = ObjectType(1000023001)
		
		val CU_MODULE = ObjectType(1000029000)
		
		val CU_FUNCTION = ObjectType(1000029001)
		...
		val BUFFER_COLLECTION = ObjectType(1000366000)
	...
	override fun toString() = when(value) {
		...
		1000023000 -> "VIDEO_SESSION"
		1000023001 -> "VIDEO_SESSION_PARAMETERS"
		1000029000 -> "CU_MODULE"
		1000029001 -> "CU_FUNCTION"
