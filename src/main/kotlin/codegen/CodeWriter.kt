...
open class CodeWriter(private val writer: Writer) : AutoCloseable by writer {
	...
	companion object {
		...
		/**
		 * Version of [use] that takes a receiver rather than a lambda parameter.
		 */
		fun<T : CodeWriter> T.with(block: T.() -> Unit) { use(block) }
	...
	/**
	 * Specifies the spacing between declarations and indentation blocks.
	 */
	 ...
	 */
	fun style(decSpacing: Int, braceSpacing: Int) = Style(decSpacing, braceSpacing)
	 ...
	 * opening and closing braces. The given [style] is applied as the [currentStyle] during the execution of the
	 * [block].
	 */
	...
	/**
	 * Version of [declaration] that consists of a single line.
	 */
