...
value class InputAttachmentAspectReference(override val address: Long) : Addressable {
	...
	class Buffer(override val address: Long, override val capacity: Int) : DirectBuffer {
		...
		operator fun set(index: Int, value: InputAttachmentAspectReference) = Unsafe.copy(value.address, offset(index), SIZE)
		...
		override fun toString() = "InputAttachmentAspectReference[$capacity]"
	...
	companion object {
		...
		val NULL = InputAttachmentAspectReference(0)
		
		val EMPTY = Buffer(0, 0)
		
		fun malloc(allocator: Allocator) = InputAttachmentAspectReference(allocator.malloc(SIZE, ALIGNMENT))
		
		fun calloc(allocator: Allocator) = InputAttachmentAspectReference(allocator.calloc(SIZE, ALIGNMENT))
