...
value class DrawIndirectCommand(override val address: Long) : Addressable {
	...
	companion object {
		...
		val NULL = DrawIndirectCommand(0)
		
		fun malloc(allocator: Allocator) = DrawIndirectCommand(allocator.malloc(SIZE, ALIGNMENT))
		
		fun calloc(allocator: Allocator) = DrawIndirectCommand(allocator.calloc(SIZE, ALIGNMENT))
