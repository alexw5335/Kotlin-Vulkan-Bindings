...
value class ImageSubresourceLayers(override val address: Long) : Addressable {
	...
	companion object {
		...
		val NULL = ImageSubresourceLayers(0)
		
		fun malloc(allocator: Allocator) = ImageSubresourceLayers(allocator.malloc(SIZE, ALIGNMENT))
		
		fun calloc(allocator: Allocator) = ImageSubresourceLayers(allocator.calloc(SIZE, ALIGNMENT))
