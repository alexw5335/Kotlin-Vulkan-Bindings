...
JNIEXPORT jlong JNICALL Java_kvb_core_FileUtils_openFileForReading(
	JNIEnv* env,
	jobject obj,
	jlong path
) {
...
JNIEXPORT jlong JNICALL Java_kvb_core_FileUtils_getFileSize(
	JNIEnv* env,
	jobject obj,
	jlong file
) {
...
JNIEXPORT void JNICALL Java_kvb_core_FileUtils_readFile(
	JNIEnv* env,
	jobject obj,
	jlong file,
	jlong size,
