...
open class CodeWriter(private val writer: Writer) : AutoCloseable by writer {
	...
	/**
	 * Version of [group] that also inserts a [groupComment] immediately before the declaration begins. This is
	...
	/**
	 * The type of comment to use when using [group] functions. Defaults to a single-line comment.
	 */
